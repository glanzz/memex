from app.constants import DEFAULT_URL, ENTITY_SYMBOL_MAPPING
from app.URL import URL
    
def show(body, encoding, view_mode=False):
  show_data = body
  if encoding:
...
def load(url: URL):
  ...
  show(url.scheme_request.body, encoding=url.scheme_request.body_encoding, view_mode=url.get_view_mode())
